        ...
        <section class="content-header">
          <h1>
            Liste des Participants&nbsp;&nbsp;&nbsp;&nbsp;
             <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal" data-href="">
                Suppression de toute la base des participants 
            </button>
          </h1>
          <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
              <div class="box">
                ...
                <?php 
                    ...
                    $nwlNon = $row2['nwl'];
                 ?> 
                  <div class="col-md-4  col-xs-12 nbr-participants no-padding"> 
                  ...
                  <div class="col-md-4  col-xs-12 no-padding-990">
                    <div class="info-box bg-green">
                      ...
                      <div class="info-box-content">
                        ...
                        <div class="progress">
                          <div class="progress-bar" style="width: <?= (($nwlOui + $nwlNon) > 0) ? ($nwlOui * 100)/($nwlOui + $nwlNon) : 0 ; ?>%"></div>
                        </div>
                        <span class="progress-description">
                          <?= number_format((($nwlOui + $nwlNon) > 0) ? ($nwlOui * 100)/($nwlOui + $nwlNon) : 0 ,0) ?>%
                        </span>
                  ...
                  <div class="col-md-4 col-xs-12 no-padding">
                    <div class="info-box bg-red">
                      ...
                      <div class="info-box-content">
                        ...
                        <div class="progress">
                          <div class="progress-bar" style="width: <?= (($nwlOui + $nwlNon) >0 ) ? ($nwlNon * 100)/($nwlOui + $nwlNon) : 0; ?>%"></div>
                        </div>
                        <span class="progress-description">
                            <?= number_format((($nwlOui + $nwlNon) >0 ) ? ($nwlNon * 100)/($nwlOui + $nwlNon) : 0,0) ?>%
                        </span>
                      </div><!-- /.info-box-content -->
                    </div><!-- /.info-box -->
                  </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>êtes vous certain de vouloir supprimer la base des participants</p>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Non</button>
            <a type="button" class="btn btn-outline" href="delete-db-users.php">Supprimer la base des participants</a>
          </div>
        </div><!-- /.modal-content -->
      </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
