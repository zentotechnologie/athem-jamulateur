  ...
  //       }
	...
	function sendEmailToCLient( $infos ){ 
		...
		if( getCurrendLang() == 'fr' ){
			...
			$mail->Body     = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-6-I"/><title>Untitled Document</title></head><body> Dear,<br/><br/> Thank you very much for using the JAMULATOR. Please find your estimate attached to this email.<br/> <br/> Feel free to contact me by email or phone to discuss your project in further detail and finalize your cost estimate. <br/> <br /> Best regards,<br/> <br/> '.$contactInfos['name'].'<br/><a href="mailto:'.$contactInfos['email'].'">'.$contactInfos['email'].'</a><br/>GSM '.$contactInfos['tel'].'<br /> <br/> <strong>THE JAM PROJECT</strong><br /> <span style="color: #555"><strong>CULTURAL SCENOGRAPHY AND PRODUCTION - ARTISTIC COLLABORATION</strong></span> </body></html>';
		}
